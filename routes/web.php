...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    Route::prefix('admin')->group(function () {
        ...
        Route::get('/suscripcion', [SuscripcionController::class, 'index'])->name('admin.suscripcion.index');
        Route::get('/suscripcion/renovar', [SuscripcionController::class, 'renovar'])->name('admin.suscripcion.renovar');
        Route::post('/suscripcion/store', [SuscripcionController::class, 'store'])->name('admin.suscripcion.store');
        Route::get('/notificacion', [NotificacionController::class, 'index'])->name('admin.notificacion.index');

        //Reporte
        Route::get('/reporte', [ReporteController::class, 'index'])->name('admin.reporte.index');
    });
